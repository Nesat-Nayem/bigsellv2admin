...
const SubscriptionAdd = () => {
  ...
  const onSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showMessage(error?.data?.message || 'Failed to create subscription', 'error')
    }
  }
    ...
    <Container>
      ...
      <Card>
        <CardHeader className="d-flex justify-content-between align-items-center gap-1">
          <CardTitle as={'h4'} className="flex-grow-1">Plan Includes</CardTitle>
      ...
      <div className="p-3 bg-light mb-3 rounded">
        <Row className="justify-content-end g-2">
          <Col lg={2}>
            <Button variant="success" type="button" className="w-100" onClick={onSave} disabled={isLoading}>
              Save
            </Button>
          </Col>
        </Row>
