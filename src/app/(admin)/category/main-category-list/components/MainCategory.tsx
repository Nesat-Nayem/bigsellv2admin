        ...
        <Col xl={12}>
          <Card>
            <CardHeader className="d-flex justify-content-between align-items-center gap-1">
              ...
              <Link href="/category/main-category-add" className="btn btn-sm btn-primary">
                + Add Category
              </Link>
            </CardHeader>
                    ...
                    <tr key={idx}>
                      ...
                      <td>
                        <div className="d-flex gap-2">
                          <Link href={`/category/main-category-edit/${item._id}`} className="btn btn-soft-primary btn-sm">
